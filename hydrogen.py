...
# Initial wave function (ground state of hydrogen atom)
...
for t in range(Nt):
    ...
    filename = f'output_images3/frame_{t:03d}.png'
...
imageio.mimsave('wave_animation3.gif', frames, duration=0.1)
